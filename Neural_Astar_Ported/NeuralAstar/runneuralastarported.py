...
def main():
    ...
    #     logger = WandbLogger(project="Neural-astar-ported")
    # subprocess.call('cd ../')
    ...
    trainer = pl.Trainer(gpus=0, log_every_n_steps=1,callbacks=[checkpoint_callback], max_epochs=400,logger=logger,num_sanity_val_steps=0,gradient_clip_val=40,weights_summary="full", deterministic=True)
    trainer.fit(model, DataModule)
    trainer.save_checkpoint("recent_multiple_bugtraps.pth")
    # if whether_wandb:
    #     wandb.save("recent_tiledmp_bf.pth")
