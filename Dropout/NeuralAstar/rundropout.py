...
#     print("HELLLLLOOOO_BEFORE")
    ...
    trainer = pl.Trainer(gpus=1, log_every_n_steps=1, max_epochs=400,logger=logger,num_sanity_val_steps=0,gradient_clip_val=40,weights_summary="full", deterministic=True)
